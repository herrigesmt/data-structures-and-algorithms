...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(value => {
    if (value.name === character) {
      characterArray = Object.values(value);
    }
  })
  if (characterArray === undefined) {
    return false;
  } else if (characterArray[2].length === 0) {
    return false;
  } else {
    return true;
  }
...
const hasChildrenEntries = (arr, character) => {
  ...
  arr.forEach(value => {
    if (value.name === character) {
      characterArray = Object.entries(value);
    }
  })
  if (characterArray === undefined) {
    return false;
  } else if (characterArray[2][1].length === 0) {
    return false;
  } else {
    return true;
  }
...
const totalCharacters = (arr) => {
  const allChars = [];
  arr.forEach(value => {
    allChars.push(value.name);
    if (value.spouse) {
      allChars.push(value.spouse);
    }
...
const houseSize = (arr) => {
  ...
  arr.forEach(value => {
    ...
    if (value.children.length > 0) { 
      number = number + value.children.length;
    }
    let house = {
      'house' : value.house,
      'members' : number
