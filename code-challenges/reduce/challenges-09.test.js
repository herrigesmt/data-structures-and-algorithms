...
const mapCurrentEvents = () => {
  const array = currentEvents.news.map(value => {
...
const countNumberOfElements = (arr) => {
  const length = arr.reduce((accumulator) => {
    accumulator++;
    return accumulator;
  },0)
  return length;
...
const returnNames = (arr) => {
  const names = arr.reduce((accumulator, value, index) => {
...
const reversedString = (str) => {
  const reverse = str.split('').reduce((accumulator, value) => {
...
const countNumberOfChildren = (arr) => {
  const children = arr.reduce((accumulator, value) => {
    if(value.children){
...
const calculateAverage = (arr) => {
  const average = arr.reduce((accumulator, value, index) => {
