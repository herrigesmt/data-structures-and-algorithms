...
const listFoods = (recipe) => {
  let result = [];
  let recipeIngredient = 0;
  result.push(recipe.ingredients[recipeIngredient].slice(15, recipe.ingredients[recipeIngredient].length));
  recipeIngredient++;
  for (let i = 0; i < 3; i++){
    result.push(recipe.ingredients[recipeIngredient].slice(9, recipe.ingredients[recipeIngredient].length));
  recipeIngredient++;
  }
  result.push(recipe.ingredients[recipeIngredient].slice(10, recipe.ingredients[recipeIngredient].length));
  recipeIngredient++;
  for (let i = 0; i < 4; i++){
    result.push(recipe.ingredients[recipeIngredient].slice(8, recipe.ingredients[recipeIngredient].length));
  recipeIngredient++;
  }
  for (let i = 0; i < 2; i++){
    result.push(recipe.ingredients[recipeIngredient].slice(10, recipe.ingredients[recipeIngredient].length));
